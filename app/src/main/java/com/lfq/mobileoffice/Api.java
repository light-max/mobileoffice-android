...
public class Api {
     ...
     */
    public static Net.Builder department(int departmentId) {
        return Net.builder().method(Net.GET)
                .typeOf(Department.class)
                .handler(new Handler())
                .url("/department/{id}")
     ...
     * @param value 新的值
     */
    public static Net.Builder setAddress(String value) {
        return Net.builder().method(Net.PUT)
                .typeOf(String.class)
                .handler(new Handler())
                .url("/employee/info/address")
                .param("value", value);
    }
     ...
     * @param value 新的值
     */
    public static Net.Builder setContact(String value) {
        return Net.builder().method(Net.PUT)
                .typeOf(String.class)
                .handler(new Handler())
