...
//    public static final String baseUrl = "http://192.168.0.112:8080";
    public static final String baseUrl = "http://192.168.43.10:8080";
    ...
    public static class Builder {
        ...
        /**
         * 设置请求所需的body，不设置会自动生成，设置后{@link Data#addParam(String, Object)}不会生效
         */
         ...
         */
        public Builder path(String key, @Nullable Object value) {
            if (data == null) {
                data = new Data();
            }
    ...
    public static class Data {
         ...
         * 添加请求参数
         */
        public Data addParam(String key, @Nullable Object value) {
            if (param == null) {
                param = new HashMap<>();
            }
            param.put(key, value);
         ...
         */
        public Data addPath(String key, @Nullable Object value) {
            if (path == null) {
                path = new HashMap<>();
            }
            path.put(key, value);
