    ...
    public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
        try {
            ...
            if (result.isSuccess()) {
                ...
                if (ResponseSetting.accessDenied() != null) {
                    ResponseSetting.accessDenied().onAccessDenied();
                }
            } else {
                onFailure(result.getMessage());
            }
...
//            uiHandler.post(() -> {
//                if (showToast&& ResponseSetting.showToast() != null) {
//                    ResponseSetting.showToast().onToast(message);
//                }
//            });
//        }
//        if (netCall != null) {
...
//        }
        Runnable runnable = () -> {
            if (uiHandler != null && showToast && ResponseSetting.showToast() != null) {
                ResponseSetting.showToast().onToast(message);
            }
            if (netCall != null) {
                netCall.onFailure(message);
